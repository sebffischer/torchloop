...
inline void* lltm_run_script_module (void* network, void* loss_fn, void* input, void* target, void* optimizer) {
  auto ret =  _lltm_run_script_module(network, loss_fn, input, target, optimizer);
  host_exception_handler();
  return ret;
}
